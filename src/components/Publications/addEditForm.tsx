...
import { AbstractAuthorHandle } from "../ui/AbstractAuthorHandle";
      ...
      <div className="bg-white dark:bg-gray-700 shadow-lg rounded-lg p-6 md:p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <AbstractAuthorHandle setValues={setAuthors} values={authors} />
          </div>
          ...
          <div>
            ...
            <div className="mb-6">
              <label htmlFor="user_id" className="block text-base font-medium text-[#180c5c] mb-2 text-left">
                Usuario
              </label>
              <Controller
                name="user_id"
            ...
            {file && (
              <div className="mt-4 align-center">
                ...
                <a href={file} target="_blank" rel="noreferrer" className="text-blue-500 mt-2 inline-block">
                  Ver archivo *
                </a>
              </div>
            )}
          ...
          <div>
            ...
            <label className="block text-base font-medium text-[#180c5c] mb-2 mt-12 text-left">
              Portada *
            </label>
            <input
              onChange={(e: ChangeEvent<HTMLInputElement>) => {
            ...
            {cover && (
              <div className="mt-4 align-center">
                <img src={cover} alt="Avatar Preview" className="w-32 h-32 object-cover rounded-full" />
              </div>
            )}
          </div>
        </div>
